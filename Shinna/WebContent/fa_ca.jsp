...
<div class="container fa">
	<div class="text-center mt-5 mb-5" >
		<h1 class="h1 font-weight-bold mb-5" style="color:#740000;">카 페</h1>
			<ul>
			 <li ><img class="picture1" src="images/ca01-1.jpg"></li>
			 <li >
				 <img class="picture2" src="images/ca01.jpg">
				 <img class="picture3" src="images/ca02.jpg">
				 <img class="picture3" src="images/ca03.jpg">
				 <img class="picture3" src="images/ca04.jpg">
			 </li>
			</ul>	
	</div>
