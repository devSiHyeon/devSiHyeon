...
<div class="container fa">
	<div class="text-center mt-5 mb-5" >
		<h1 class="h1 font-weight-bold mb-5" style="color:#740000;">라 운 지</h1>
			<ul>
			 <li ><img class="picture1" src="images/lo01-1.jpg"></li>
			 <li >
				 <img class="picture2" src="images/lo01.jpg">
				 <img class="picture3" src="images/lo02.jpg">
				 <img class="picture3" src="images/lo03.jpg">
				 <img class="picture3" src="images/lo04.jpg">
			 </li>
			</ul>	
	</div>
