...
<div class="container fa">
	<div class="text-center mt-5 mb-5" >
		<h1 class="h1 font-weight-bold mb-5" style="color:#740000;">샤 워 장</h1>
			<ul>
			 <li ><img class="picture1" src="images/sa01-1.jpg"></li>
			 <li >
				 <img class="picture2" src="images/sa01.jpg">
				 <img class="picture3" src="images/sa02.jpg">
				 <img class="picture3" src="images/sa03.jpg">
				 <img class="picture3" src="images/sa04.jpg">
			 </li>
			</ul>	
	</div>
