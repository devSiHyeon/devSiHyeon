...
<% 
	...
	Connection con=null;
		...
		try{
			...
			pstmt=con.prepareStatement("select * from member order by country desc, name asc");
					...
					<li class="nav-item " style="width:100%; ">
						<div class="dropdown lang">
	    					<button class="text-left btn btn-white dropdown-toggle" type="button"
									id="dropdownMenuButton" data-toggle="dropdown"
									aria-haspopup="true" aria-expanded="false" style="width:100%; "><img src="images/dia.png" style="width:27px; height:27px;">shinna604님 </button>
	  ...
	  <tbody style="font-size:14px;">
	  	<%while(rs.next()){ %>
			<tr >
				...
				<td >(<%=rs.getString("tel_1") %> )<br><%=rs.getInt("tel_2") %></td>
				<td><%=rs.getString("e_mail") %>@<%=rs.getString("e_mail2") %></td>
				<td class="text-center"><%=rs.getString("gender") %></td>
				<td class="text-center"><a href="memberDelete.do?id=<%=rs.getString("id") %>" 
